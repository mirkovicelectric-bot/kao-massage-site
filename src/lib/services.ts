...
export const services: Service[] = [
  {
    ...
    image: 'https://images.unsplash.com/photo-nMVUTY8_gGw?w=800&q=80&auto=format&fit=crop',
    imageAlt: 'Therapist applying bodywork during a traditional Thai massage session',
    featured: true,
    tag: 'Most Popular',
    durations: [
  ...
  },
  {
    ...
    image: 'https://images.unsplash.com/photo-a9pFSC8dTlo?w=800&q=80&auto=format&fit=crop',
    imageAlt: 'Therapist working with both hands on a client\'s back and shoulders',
    featured: true,
    durations: [
  ...
  },
  {
    ...
    image: 'https://images.unsplash.com/photo-hBLf2nvp-Yc?w=800&q=80&auto=format&fit=crop',
    imageAlt: 'Therapist applying firm pressure to a client\'s back muscles during deep tissue massage',
    featured: true,
    durations: [
  ...
  },
  {
    ...
    image: 'https://images.unsplash.com/photo-cU53ZFBr3lk?w=800&q=80&auto=format&fit=crop',
    imageAlt: 'Client resting in prone position during a calming Swedish relaxation massage',
    durations: [
      { duration: '60 min', price: 105 },
      { duration: '90 min', price: 155 },
      { duration: '120 min', price: 205 },
  ...
  },
  {
    ...
    image: 'https://images.unsplash.com/photo-lwl1sXHZ56E?w=800&q=80&auto=format&fit=crop',
    imageAlt: 'Natural massage oil bottles and botanicals arranged for an aromatherapy session',
    durations: [
  ...
  },
  {
    ...
    image: 'https://images.unsplash.com/photo-_TyrA1RUaiI?w=800&q=80&auto=format&fit=crop',
    imageAlt: 'Heated basalt stones placed along a client\'s back during hot stone massage',
    tag: 'Signature',
    durations: [
  ...
  },
  {
    ...
    image: 'https://images.unsplash.com/photo-SKbplAj2ixk?w=800&q=80&auto=format&fit=crop',
    imageAlt: 'Therapist applying precise pressure to reflex points on a client\'s foot',
    durations: [
  ...
  },
  {
    ...
    image: 'https://images.unsplash.com/photo-9BjH8jl7Uj0?w=800&q=80&auto=format&fit=crop',
    imageAlt: 'Therapist working on a client\'s upper back and shoulder muscles in a professional spa',
    durations: [
